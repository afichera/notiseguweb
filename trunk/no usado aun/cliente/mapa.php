...
<script src="http://maps.google.com/maps?file=api&v=2&key=ABQIAAAAjU0EJWnWPMv7oQ-jjS7dYxTPZYElJSBeBUeMSX5xXgq6lLjHthSAk20WnZ_iuuzhMt60X_ukms-AUg"
    ...
    function load() {
      if (GBrowserIsCompatible()) {
        ...
        GDownloadUrl("xml.php?id_cliente=<?php echo $id_cliente?>", function(data) {
    ...
    function createMarker(point, name, address, type) {
      ...
      var html = "<b>" + name + "</b> <br/>" + address + "</b> <br/>--" + type + "--<br/><a href='../cliente/alarmas.php'>Activar/Desactivar Alarma</a>";
...
<body onload="load()" onunload="GUnload()">
    <div id="map" style="width: 900px; height:360px; border:double; border-color:#09C" ></div>
