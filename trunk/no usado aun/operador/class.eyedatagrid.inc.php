...
class EyeDataGrid
{
	...
	*/
	private function buildFooter($shown, $first = 0, $last = 0)
	{
		...
		echo '<tfoot><tr class="tbl-footer"><td class="tbl-nav" colspan="' . $this->column_count . '"><table width="100%" class="tbl-footer"><tr><td width="33%" class="tbl-found">Se encontraron <em>' . $this->row_count . '</em> resultados';

		if ($this->row_count > 0)
			echo ', mostrando de <em>' . $first . '</em> a <em>' . $last . '</em>';
